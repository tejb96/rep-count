...
const HomePage = () => {
    return (
        <Container>
            <Box sx={{ my: 4, textAlign: 'center', color: "grey" }}>
                ...
                <Typography variant="h6" component="p" sx={{ mt: 2 }}>
                    Not ready to sign up? No problem! You can check out the tracker without signing in by following <Link to="/path-placeholder">this link</Link>.
                </Typography>
            </Box>
        </Container>
    );
